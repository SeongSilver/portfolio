...
export default function ProjectItem({ id, data, openModalHandler }) {
  ...
  return (
    <>
      <div className="project-card !z-1">
        <Image
        ...
        <div className="p-4 flex flex-col">
          ...
          <div>
            {tag.map((tag) => (
              <span className="mr-1 p-1 text-sm py-1 bg-slate-500 rounded-md bg-skyblue-500 dark:bg-skyblue-700 w-30">
                {" "}
                {tag.name}
              </span>
            ))}
